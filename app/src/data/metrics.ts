...
export const trackers: Tracker[] = [
  {
    ...
    last_match: "Today",
    frequency: "Weekly",
    latestFinding: "CalPERS deployed $200M to Stonepeak Renewables II \u2014 largest infra allocation this quarter",
    newAlerts: 3,
  },
  {
    ...
    frequency: "Daily",
    latestFinding: "NY State CRF terminated T. Rowe Price \u2014 $2B public equity mandate unwound",
    newAlerts: 1,
  },
  {
    ...
    frequency: "Monthly",
    latestFinding: "SBCERA PE portfolio IRR at 14.2% \u2014 outperforming benchmark by 180bps",
    newAlerts: 0,
  },
  {
    ...
    frequency: "Weekly",
    latestFinding: "Last scan: NJ DOI committed $150M to Ares Real Estate Fund VII",
    newAlerts: 0,
  },
];
